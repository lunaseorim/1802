...
remDr$navigate("https://facebook.com/assemnamu")
...
while(len<501){
  webElems <- remDr$findElements(using = 'css selector', "._1dwg _1w_m _q7o")
  len <- length(webElems)
  print(len)
...
weblogin <- remDr$findElements(using = 'css selector', id="m_login_email")
weblogin$sendkeystoelement()
remDr$findElement(using = 'css selector', "m_login_email")
